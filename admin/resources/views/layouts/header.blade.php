...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/logo11.png">
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="images/img-1-removebg.png" width="20" alt="">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="page-login.html" class="dropdown-item ai-icon" href="{{ route('logout') }}"   onclick="event.preventDefault();
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<div class="main-profile">
					<div class="image-bx">
						<img src="images/img-1-removebg.png" alt="">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="{{url('category')}}" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="{{url('addCategory')}}" aria-expanded="false">
						<i class="flaticon-077-menu-1"></i>
							<span class="nav-text">
                                Add Category
                            </span>
                    ...
                    <li class="nav-label">Apps</li>
                    <li><a class="has-arrow ai-icon" href="{{url('product')}}" aria-expanded="false">
						<i class="flaticon-077-menu-1"></i>
							<span class="nav-text">
                                Product
                            </span>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{url('addProduct')}}" aria-expanded="false">
						<i class="flaticon-077-menu-1"></i>
							<span class="nav-text">
                                Add Product
                            </span>
                    ...
                    <li class="nav-label">Apps</li>
                    <li><a class="has-arrow ai-icon" href="{{url('userr')}}" aria-expanded="false">
						<i class="flaticon-077-menu-1"></i>
							<span class="nav-text">
                                User
                            </span>
                    ...
                    <li class="nav-label">Apps</li>
                    <li><a class="has-arrow ai-icon" href="{{url('booking')}}" aria-expanded="false">
						<i class="flaticon-077-menu-1"></i>
							<span class="nav-text">
                                Booking
                            </span>
				...
				<div class="copyright">
					...
					<p class="fs-12">Made with <span class="heart"></span> by mohammad alissa</p>
				</div>
			</div>
        </div>
        <!--**********************************
